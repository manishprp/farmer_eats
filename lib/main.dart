...
void setupLocator() {
  ...
  GetIt.I.registerLazySingleton<OTPVerifyBLoc>(() => OTPVerifyBLoc());
  GetIt.I.registerLazySingleton<FlutterSecureStorage>(
      () => const FlutterSecureStorage());
  GetIt.I.registerLazySingleton<Store>(() => Store()); //ForgotPasswordBloc
  GetIt.I.registerLazySingleton<ForgotPasswordBloc>(() => ForgotPasswordBloc());
